...
public class ExitRoom extends IQ {

    public static final String ELEMENT = QUERY_ELEMENT;
    public static final String NAMESPACE = "http://mesoftware.cn/groupchat/member/remove";
    ...
    public ExitRoom(Map<String, String> attributes) {
        this(null, attributes);
    }

    public ExitRoom(String instructions, Map<String, String> attributes) {
