...
public class JoinRoom extends IQ {
    ...
    public static final String NAMESPACE = "http://mesoftware.cn/groupchat/member/add";
    ...
    public JoinRoom(Map<String, String> attributes) {
        this(null, attributes);
    }

    public JoinRoom(String instructions, Map<String, String> attributes) {
