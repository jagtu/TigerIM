...
public class RecordVoiceManager {
    ...
    public void startRecordVoice() {
        ...
        try {
            ...
            recorder.setOutputFormat(MediaRecorder.OutputFormat.RAW_AMR);// 内容输出格式
            recorder.setAudioEncoder(MediaRecorder.AudioEncoder.AMR_NB); // 音频编码方式

            audioFile = new File(mVoiceDir, DateUtil.formatDatetime(new Date(), "yyyyMMddHHmmss") + ".amr");
            if(!audioFile.exists()) {
    ...
    public static abstract class RecordFinishListener {
         ...
         */
        public abstract void onFinish(File audioFile, double duration);
